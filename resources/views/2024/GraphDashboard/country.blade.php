    ...
    <body>
        ...
        <script type="text/javascript">
            ...
            Highcharts.chart('container', {
                ...
                title: {
                    text: 'Number of Active Policy per Country'
                },
                xAxis: {
                    ...
                    labels: {
                        ...
                        formatter: function() {
                            return '<a href="/2024/dashboard_index/country_index?country_residence=' + encodeURIComponent(this.value) + '">' + this.value + '</a>';
                        },
                        style: {
                            textAlign: 'center',
                            whiteSpace: 'nowrap'
                ...
                plotOptions: {
                    ...
                    series: {
                        ...
                        point: {
                            events: {
                                click: function () {
                                    var url = '/2024/dashboard_index/country_index?country_residence=' + encodeURIComponent(this.category);
