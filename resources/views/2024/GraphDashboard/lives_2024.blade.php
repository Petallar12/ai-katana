    ...
    <body>
        ...
        <div class="container">
            <div>
                <ul>
                    <li
                        class="sum"
                        onclick="redirectTo('newlives_2024_index')"
                        id="totalNewLives"
                    ></li>
            ...
            <div>
                <ul>
                    <li
                        class="sum"
                        onclick="redirectTo('existing_2024_index')"
                        id="totalRenewals"
                    ></li>
        ...
        <script type="text/javascript">
            function redirectTo(page) {
                window.location.href = `/2024/dashboard_index/${page}`;
            }
                            ...
                            events: {
                                click: function () {
                                    ...
                                    if (this.series.name === 'New Lives') {
                                        url = '/2024/dashboard_index/newlives_2024_index?placement_date=' + encodeURIComponent(this.category);
                                    } else if (this.series.name === 'Renewals') {
                                        url = '/2024/dashboard_index/existing_2024_index?start_date=' + encodeURIComponent(this.category);
                                    }
                                    if (url) {
