...
<div class="table-wrapper">
    <div class="button">
     ...
     <div class="card-x">
        <p class="card-x-header">Add Client 2024</p>
        <!-- Nav tabs -->
    ...
    <!-- FORM START -->
    <form id="main-form" action="{{ url('2024/accountsection') }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('POST')
        ...
        <div class="tab-content">
            ...
            <div id="insurance" class="tab-pane fade" role="tabpanel" aria-labelledby="insurance-tab">
                <div class="form-wrapper">
                    ...
                    <div class="field-info">
                        <label class="field-label" for="lives_2024">Client Status<span class="required">*</span></label>
                        <select class="field-data" id="dropdown" name="lives_2024" required>
                    ...
                    <div class="field-info">
                        ...
                        <input class="field-data" type="date" name="original_date" placeholder="Enter original joined date" maxlength="10" min="1900-01-01" max="2100-12-31" requires>
                    </div>
                    ...
                    <div class="field-info">
                        ...
                        <input class="field-data" type="text" name="percentage_loading_2024" placeholder="Enter loading percentage">
                    </div>
            ...
            <div id="renewal" class="tab-pane fade" role="tabpanel" aria-labelledby="renewal-tab">
                <div class="form-wrapper">
                    ...
                    <div class="field-info">
                        <label class="field-label" for="case_officer_2024">Case Officer Handling Renewal</label>
                    ...
                    <div class="field-info">
                        ...
                        <input class="field-data" type="text" name="renewal_discount_2024" placeholder="Enter renewal discount">
                    </div>
                </div>
            </div>
            ...
            <div id="placement" class="tab-pane fade" role="tabpanel" aria-labelledby="placement-tab">
                <div class="form-wrapper">
                    ...
                    <div class="field-info">
                        ...
                        <input class="field-data" type="float" name="commission_2024" placeholder="Enter commission received">
                    </div>
