...
<html>
<head>
  <title>Clients per Country 2024</title>
  <meta charset="utf-8">
...
<body>
   ...
   <div class="header-section">
      ...
      <div class="button">
        <a href="/2024/dashboard/country"><i class="fa fa-arrow-left" aria-hidden="true"></i></a>
    </div>
    <center><h1 class="title-header">Clients per Country 2024</h1></center>
  ...
  <script type="text/javascript">
      $(document).ready(function () {
          const table = $('#table').DataTable({
              ...
              "serverSide": true,
              "ajax": {
                  "url": "{{ route('country_index') }}",
                  "data": function(d) {
                // Get the source inquiry parameter from the URL
                const urlParams = new URLSearchParams(window.location.search);
                const countryFilter = urlParams.get('country_residence');
                // Add it to the data object sent to the server
                d.country_residence = countryFilter;
            }
          },
              "columns": [
