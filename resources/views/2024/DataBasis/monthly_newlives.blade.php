        ...
        <div class="card">
            <table id='myTable10' class="table">
                ...
                <tbody>
                    ...
                    $case_closed = array();
                    $query = "SELECT DISTINCT case_closed FROM accountsection_2024 
                              WHERE (lives_2024 = 'New Lives' OR lives_2024 = 'New Lives and Existing') 
                              AND insurance_type ='IPMI' 
                              AND (policy = 'Active' OR policy = 'Pended')     
                              AND (status = 'Complete' OR status = 'Incomplete')
                              AND placement_date BETWEEN '2024-01-01' AND '2024-12-31' 
