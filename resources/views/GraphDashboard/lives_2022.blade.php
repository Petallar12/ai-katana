    ...
    <body>
        ...
        <script type="text/javascript">
            function redirectTo(page) {
                window.location.href = `/2022/dashboard_index/${page}`;
            }
                            ...
                            events: {
                                click: function () {
                                    ...
                                    if (this.series.name === 'New Lives') {
                                        url = '/2022/dashboard_index/newlives_2022_index?placement_date=' + encodeURIComponent(this.category);
                                    } else if (this.series.name === 'Renewals') {
                                        url = '/2022/dashboard_index/existing_2022_index?start_date=' + encodeURIComponent(this.category);
                                    }
                                    if (url) {
