...
<!-- HEADER -->
<div class="header">
    <h2 class="title-header">IPMI DASHBOARD 2023</h2>
...
<div class="dashboard-container">
    ...
    <div class="graph-card">
        <div class="graph-card-header">
            ...
            <a href="/2023/dashboard/premium_commission" target="_blank">
        ...
        <div class="graph-card-footer">
            <iframe
                ...
                src="/2023/dashboard/premium_commission"
                frameborder="0"
                class="auto-height"
            ></iframe>
        </div>
    ...
    <div class="graph-card">
        <div class="graph-card-header">
            ...
            <a href="/2023/dashboard/lives_2023">
                <i class="bx bx-fullscreen bx-burst-hover bx-sm"></i>
            </a>
        </div>
        <div class="graph-card-footer">
            <iframe
                id="lives_2023_iframe"
                src="/2023/dashboard/lives_2023"
                frameborder="0"
                class="auto-height"
            ></iframe>
        </div>
    ...
    <div class="graph-card">
        <div class="graph-card-header">
            ...
            <a href="/2023/dashboard/source_inquiry">
                <i class="bx bx-fullscreen bx-burst-hover bx-sm"></i>
            </a>
        </div>
        <div class="graph-card-footer">
            <iframe
                ...
                src="/2023/dashboard/source_inquiry"
                frameborder="0"
                class="auto-height"
            ></iframe>
        </div>
    ...
    <div class="graph-card">
        <div class="graph-card-header">
            ...
            <a href="/2023/dashboard/country_premium">
                <i class="bx bx-fullscreen bx-burst-hover bx-sm"></i>
            </a>
        </div>
        <div class="graph-card-footer">
            <iframe
                ...
                src="/2023/dashboard/country_premium"
                frameborder="0"
                class="auto-height"
            ></iframe>
        </div>
    ...
    <div class="graph-card">
        <div class="graph-card-header">
            ...
            <a href="/2023/dashboard/insurer_premium">
                <i class="bx bx-fullscreen bx-burst-hover bx-sm"></i>
            </a>
        </div>
        <div class="graph-card-footer">
            <iframe
                ...
                src="/2023/dashboard/insurer_premium"
                frameborder="0"
                class="auto-height"
            ></iframe>
        </div>
    ...
    <!-- MONTHLY NEW LIVES 2023 -->
    <div class="graph-card">
        <div class="graph-card-header">
            <h3>Case Closed Count for New Lives</h3>
            <a href="/2023/databasis/monthly_newlives">
                <i class="bx bx-fullscreen bx-burst-hover bx-sm"></i>
            </a>
        </div>
        <div class="graph-card-footer">
            <iframe
                ...
                src="/2023/databasis/monthly_newlives"
                frameborder="0"
                class="auto-height"
            ></iframe>
        </div>
    ...
    <!-- MONTHLY RENEWALS 2023 -->
    <div class="graph-card">
        <div class="graph-card-header">
            <h3>Case Closed Count for Renewals</h3>
            <a href="/2023/databasis/monthly_renewals">
                <i class="bx bx-fullscreen bx-burst-hover bx-sm"></i>
            </a>
        </div>
        <div class="graph-card-footer">
            <iframe
                ...
                src="/2023/databasis/monthly_renewals"
                frameborder="0"
                class="auto-height"
            ></iframe>
        </div>
