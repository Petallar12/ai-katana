...
<div class="table-wrapper">
    <div class="button">
     ...
     <div class="card-x">
        <p class="card-x-header">Edit Client:</p><h2>{{ $accountsection_2023->full }}</h2>
        <!-- Nav tabs -->
    ...
    <!-- FORM START -->
    <form id="main-form" action="/2023/accountsection/{{ $accountsection_2023->id }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PATCH')
            ...
            <div id="personal" class="tab-pane fade show active" role="tabpanel" aria-labelledby="personal-tab">
                <div class="form-wrapper">
                    ...
                    <div class="field-info">
                        ...
                        <input class="field-data" type="text" id="smalll-input" name="membership" id="membership" value="{{$accountsection_2023->membership}}">
                    </div>

                    <div class="field-info">
                        <label class="field-label" for="title">Title</label>
                        <select class="field-data" name="title" id="dropdown">
                            <option value="" disabled selected>{{$accountsection_2023->title}}</option>
                    ...
                    <div class="field-info">
                        ...
                        <input class="field-data" type="text" name="full" value="{{$accountsection_2023->full}}" required>
                    </div>

                    <div class="field-info">
                        <label class="field-label">First Name</label>
                        <input class="field-data" type="text" name="first" value="{{$accountsection_2023->first}}" />
                    </div>

                    <div class="field-info">
                        <label class="field-label">Family Name</label>
                        <input class="field-data" type="text" name="family" value="{{$accountsection_2023->family}}" />
                    </div>

                    <div class="field-info">
                        <label class="field-label" for="gender">Gender</label>
                        <select class="field-data" id="dropdown" name="gender">
                            <option value="" disabled selected>{{$accountsection_2023->gender}}</option>
                    ...
                    <div class="field-info">
                        ...
                        <input class="field-data" type="date" name="birthday" value="{{$accountsection_2023->birthday}}" maxlength="10" min="1900-01-01" max="2100-12-31">
                    </div>

                    <div class="field-info">
                        <label class="field-label">Age</label>
                        <input class="field-data" type="number" name="age" value="{{$accountsection_2023->age}}">
                    </div>
                    ...
                    <div class="field-info">
                        ...
                        <select class="field-data" id="country_nationality" name="country_nationality">
                            <option value="" disabled selected>
                                ...
                                {{$accountsection_2023->country_nationality}}</option>
                        </select>
                    </div>
                    ...
                    <div class="field-info">
                        ...
                        <select class="field-data" id="country_residence" name="country_residence">
                            <option value="" disabled selected>
                                <!-- Option is taken from json/countries.json -->
                                {{$accountsection_2023->country_residence}}</option>
                        </select>
                    </div>

                    <div class="field-info">
                        <label class="field-label">Residence Address</label>
                        <input class="field-data" type="text" name="residence" value="{{$accountsection_2023->residence}}">
                    </div>

                    <div class="field-info">
                        <label class="field-label">Mailing Address</label>
                        <input class="field-data" type="text" name="mailing_address" value="{{$accountsection_2023->mailing_address}}">
                    </div>

                    <div class="field-info">
                        <label class="field-label">Primary Contact Number</label>
                        <input class="field-data" type="float" name="contact_number" value="{{$accountsection_2023->contact_number}}">
                    </div>

                    <div class="field-info">
                        <label class="field-label">Secondary Contact Number</label>
                        <input class="field-data" type="float" name="secondary_contact_number" value="{{$accountsection_2023->secondary_contact_number}}">
                    </div>

                    <div class="field-info">
                        <label class="field-label">Primary Personal Email Address</label>
                        <input class="field-data" type="email" name="applicant_email_address" value="{{$accountsection_2023->applicant_email_address}}">
                    </div>

                    <div class="field-info">
                        <label class="field-label">Secondary Personal Email Address</label>
                        <input class="field-data" type="email" name="secondary_personal_email" value="{{$accountsection_2023->secondary_personal_email}}">
                    </div>
                ...
                <div class="form-wrapper">
                    ...
                    <div class="field-info">
                        ...
                        <select class="field-data" id="dropdown" name="insurance_type">
                            <option value="" disabled selected>{{$accountsection_2023->insurance_type}}</option>
                    ...
                    <div class="field-info">
                        <label class="field-label" for="lives_2023">Client Status</label>
                        <select class="field-data" id="dropdown" name="lives_2023">
                            <option value="" disabled selected>{{$accountsection_2023->lives_2023}}</option>
                    ...
                    <div class="field-info">
                        ...
                        <select class="field-data" id="insurer" name="insurer">
                            ...
                            <option value="" disabled selected>{{$accountsection_2023->insurer}}</option>
                        </select>
                    </div>

                    <div class="field-info">
                        <label class="field-label">Type of Cover</label>
                        <input class="field-data" type="text" name="cover" value="{{$accountsection_2023->cover}}">
                    </div>

                    <div class="field-info">
                        <label class="field-label">Product Type</label>
                        <input class="field-data" type="text" name="product_type" value="{{$accountsection_2023->product_type}}">
                    </div>

                    <div class="field-info">
                        <label class="field-label">Deductible / Excess / Cost Share / OOPM / Co-Payment</label>
                        <input class="field-data" type="text" name="payment" value="{{$accountsection_2023->payment}}">
                    </div>

                    <div class="field-info">
                        <label class="field-label">Group Name</label>
                        <input class="field-data" type="text" name="group_name" value="{{$accountsection_2023->group_name}}">
                    </div>

                    <div class="field-info">
                        <label class="field-label">Group Number</label>
                        <input class="field-data" type="text" name="group_number" value="{{$accountsection_2023->group_number}}">
                    </div>
                    ...
                    <div class="field-info">
                        ...
                        <select class="field-data" id="dropdown" name="group_identifier">
                            <option value="" disabled selected>{{$accountsection_2023->group_identifier}}</option>
                    ...
                    <div class="field-info">
                        ...
                        <select class="field-data" id="dropdown" name="type_applicant">
                            <option value="" disabled selected>{{$accountsection_2023->type_applicant}}</option>
                    ...
                    <div class="field-info">
                        ...
                        <input class="field-data" type="text" name="main_applicant_deps" value="{{$accountsection_2023->main_applicant_deps}}">
                    </div>

                    <div class="field-info">
                        <label class="field-label">Original Joined Date</label>
                        <input class="field-data" type="date" name="original_date" value="{{$accountsection_2023->original_date}}" maxlength="10" min="1900-01-01" max="2100-12-31">
                    </div>

                    <div class="field-info">
                        <label class="field-label">Start Date</label>
                        <input class="field-data" type="date" name="start_date" value="{{$accountsection_2023->start_date}}" maxlength="10" min="1900-01-01" max="2100-12-31">
                    </div>

                    <div class="field-info">
                        <label class="field-label">End Date</label>
                        <input class="field-data" type="date" name="end_date" value="{{$accountsection_2023->end_date}}" maxlength="10" min="1900-01-01" max="2100-12-31">
                    </div>

                    <div class="field-info">
                        <label class="field-label">Cancelled Date</label>
                        <input class="field-data" type="date" name="cancelled_date" value="{{$accountsection_2023->cancelled_date}}" maxlength="10" min="1900-01-01" max="2100-12-31">
                    </div>

                    <div class="field-info">
                        <label class="field-label">Reason for Cancellation</label>
                        <input class="field-data" type="text" name="cancelled_remarks" value="{{$accountsection_2023->cancelled_remarks}}">
                    </div>

                    <div class="field-info">
                        <label class="field-label">Primary Contact Person's Email Address</label>
                        <input class="field-data" type="email" name="email_address" value="{{$accountsection_2023->email_address}}">
                    </div>

                    <div class="field-info">
                        <label class="field-label">Secondary Contact Person's Email Address</label>
                        <input class="field-data" type="email" name="secondary_contact_person_email" value="{{$accountsection_2023->secondary_contact_person_email}}">
                    </div>

                    <div class="field-info">
                        <label class="field-label">Credentials Submitted</label>
                        <input class="field-data" type="text" name="credentials" value="{{$accountsection_2023->credentials}}">
                    </div>

                    <div class="field-info">
                        <label class="field-label">Area of Cover</label>
                        <input class="field-data" type="text" name="area_cover" value="{{$accountsection_2023->area_cover}}">
                    </div>

                    <div class="field-info">
                        <label class="field-label">Pro-rated Premium Amount</label>
                        <input class="field-data" type="float" name="pro_rated_premium" value="{{$accountsection_2023->pro_rated_premium}}">
                    </div>

                    <div class="field-info">
                        <label class="field-label">Premium Amount</label>
                        <input class="field-data" type="float" name="premium" value="{{$accountsection_2023->premium}}">
                    </div>

                    <div class="field-info">
                        <label class="field-label">Active Premium Amount</label>
                        <input class="field-data" type="float" name="active_premium" value="{{$accountsection_2023->active_premium}}">
                    </div>

                    <div class="field-info">
                        <label class="field-label">Frequency Premium</label>
                        <input class="field-data" type="float" name="frequency_premium" value="{{$accountsection_2023->frequency_premium}}">
                    </div>

                    <div class="field-info">
                        <label class="field-label">Convert Premium to USD</label>
                        <input class="field-data" type="float" name="convert_premium_USD" value="{{$accountsection_2023->convert_premium_USD}}">
                    </div>
                    ...
                    <div class="field-info">
                        ...
                        <select class="field-data" id="dropdown" name="payment_frequency">
                            <option value="" disabled selected>{{$accountsection_2023->payment_frequency}}</option>
                    ...
                    <div class="field-info">
                        ...
                        <select class="field-data" id="dropdown" name="mode_payment">
                            <option value="" disabled selected>{{$accountsection_2023->mode_payment}}</option>
                    ...
                    <div class="field-info">
                        ...
                        <select class="field-data" id="dropdown" name="subscription_currency">
                            <option value="" disabled selected>{{$accountsection_2023->subscription_currency}}</option>
                    ...
                    <div class="field-info">
                        ...
                        <input class="field-data" type="float" name="medical818_prem_account" value="{{$accountsection_2023->medical818_prem_account}}">
                    </div>

                    <div class="field-info">
                        <label class="field-label">Medical818 Premium Amount (USD)</label>
                        <input class="field-data" type="float" name="medical818_prem_account_USD" value="{{$accountsection_2023->medical818_prem_account_USD}}">
                    </div>

                    <div class="field-info">
                        <label class="field-label">Medical818 Admin Fee</label>
                        <input class="field-data" type="float" name="medical818_admin" value="{{$accountsection_2023->medical818_admin}}">
                    </div>

                    <div class="field-info">
                        <label class="field-label">Loading Percentage</label>
                        <input class="field-data" type="text" name="percentage_loading_2023" value="{{$accountsection_2023->percentage_loading_2023}}">
                    </div>

                    <div class="field-info">
                        <label class="field-label">Company Product Discount</label>
                        <input class="field-data" type="text" name="company_product_discount" value="{{$accountsection_2023->company_product_discount}}">
                    </div>

                    <div class="field-info">
                        <label class="field-label">Further Discount</label>
                        <input class="field-data" type="text" name="further_discount" value="{{$accountsection_2023->further_discount}}">
                    </div>

                    <div class="field-info">
                        <label class="field-label" for="policy">Policy Status</label>
                        <select class="field-data" id="dropdown" name="policy">
                            <option value="" disabled selected>{{$accountsection_2023->policy}}</option>
                    ...
                    <div class="field-info">
                        ...
                        <select class="field-data" id="case_closed" name="case_closed">
                            ...
                            <option value="" disabled selected>{{$accountsection_2023->case_closed}}</option>
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div id="renewal" class="tab-pane fade" role="tabpanel" aria-labelledby="renewal-tab">
                <div class="form-wrapper">
                    ...
                    <div class="field-info">
                        ...
                        <input class="field-data" type="date" name="renewal_date" value="{{$accountsection_2023->renewal_date}}" maxlength="10" min="1900-01-01" max="2100-12-31">
                    </div>
                    ...
                    <div class="field-info">
                        ...
                        <select class="field-data" id="renewal_closed" name="case_officer_2023">
                            <option value="" disabled selected>{{$accountsection_2023->case_officer_2023}}</option>
                    ...
                    <div class="field-info">
                        ...
                        <input class="field-data" type="text" name="renewal_discount_2023" value="{{$accountsection_2023->renewal_discount_2023}}">
                    </div>
                </div>
            </div>
                ...
                <div class="form-wrapper">
                    ...
                    <div class="field-info">
                        ...
                        <select class="field-data" id="placement_done" name="placement_done">
                            <option value="" disabled selected>{{$accountsection_2023->placement_done}}</option>
                        </select>
                    </div>

                    <div class="field-info">
                        <label class="field-label">Placement Date</label>
                        <input class="field-data" type="date" name="placement_date" value="{{$accountsection_2023->placement_date}}" maxlength="10" min="1900-01-01" max="2100-12-31">
                    </div>

                    <div class="field-info">
                        <label class="field-label" for="account">Broker Account</label>
                        <select class="field-data" id="dropdown" name="account">
                            <option value="" disabled selected>{{$accountsection_2023->account}}</option>
                    ...
                    <div class="field-info">
                        ...
                        <select class="field-data" id="dropdown" name="account_code">
                            <option value="" disabled selected>{{$accountsection_2023->account_code}}</option>
                    ...
                    <div class="field-info">
                        ...
                        <select class="field-data" id="dropdown" name="payment_status">
                            <option value="" disabled selected>{{$accountsection_2023->payment_status}}</option>
                    ...
                    <div class="field-info">
                        ...
                        <input class="field-data" type="float" name="percentage_commission" value="{{$accountsection_2023->percentage_commission}}">
                    </div>

                    <div class="field-info">
                        <label class="field-label">Commission Received</label>
                        <input class="field-data" type="float" name="commission_2023" value="{{$accountsection_2023->commission_2024}}">
                    </div>
                ...
                <div class="form-wrapper">
                    ...
                    <div class="field-info">
                        ...
                        <select class="field-data" id="dropdown" name="source_inquiry">
                            <option value="" disabled selected>{{$accountsection_2023->source_inquiry}}</option>
                    ...
                    <div class="field-info">
                        ...
                        <input class="field-data" type="text" name="referral_name" value="{{$accountsection_2023->referral_name}}">
                    </div>

                    <div class="field-info">
                        <label class="field-label">Sub-Agent Name</label>
                        <input class="field-data" type="text" name="sub_agents_name" value="{{$accountsection_2023->sub_agents_name}}">
                    </div>

                    <div class="field-info">
                        <label class="field-label">Sub-Agent Percentage Commission</label>
                        <input class="field-data" type="text" name="sub_agent_percentage" value="{{$accountsection_2023->sub_agent_percentage}}">
                    </div>

                    <div class="field-info">
                        <label class="field-label">Commission Paid to Sub-Agent</label>
                        <input class="field-data" type="text" name="commission_paid" value="{{$accountsection_2023->commission_paid}}">
                    </div>
            ...
            <div id="others" class="tab-pane fade" role="tabpanel" aria-labelledby="others-tab">
                <div class="form-wrapper">
                    ...
                    <div class="field-info">
                        ...
                        <input class="field-data" type="text" name="encoded_by" value="{{$accountsection_2023->encoded_by}}" readonly>
                    </div>
                    ...
                    <div class="field-info">
                        ...
                        <select class="field-data" id="dropdown" name="status">
                            <option value="" disabled selected>{{$accountsection_2023->status}}</option>
                    ...
                    <div class="field-info">
                        ...
                        <input class="field-data" type="text" name="missing_remarks" value="{{$accountsection_2023->missing_remarks}}">
                    </div>

                    <div class="field-info">
                        <label class="field-label">Remarks</label>
                        <input class="field-data" type="text" name="remarks" value="{{$accountsection_2023->remarks}}">
                    </div>
                </div>
            </div>
        </div>
