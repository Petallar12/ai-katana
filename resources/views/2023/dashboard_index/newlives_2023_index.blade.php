...
<html>
<head>
  <title>Monthly Count of New Lives 2023</title>
  <meta charset="utf-8">
...
<body>
   <div class="header-section">
      <div class="button">
        <a href="/2023/dashboard/lives_2023"><i class="fa fa-arrow-left" aria-hidden="true"></i></a>
    </div>
    <center><h1 class="title-header">Monthly Count of New Lives 2023</h1></center>
      </div>
  ...
  <script type="text/javascript">
      $(document).ready(function () {
          const table = $('#table').DataTable({
              ...
              "serverSide": true,
              "ajax": {
    "url": "{{ route('newlives_2023_index_2023') }}",
    "data": function(d) {
        const urlParams = new URLSearchParams(window.location.search);
        const placement_dateFilter = urlParams.get('placement_date');
        console.log('Placement Date:', placement_dateFilter); // Add this line
        if (placement_dateFilter) {
            d.placement_date = placement_dateFilter;
        }
    }
},
