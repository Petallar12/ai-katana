...
<html>
<head>
  <title>Number of Clients in country per premium 2023</title>
  <meta charset="utf-8">
...
<body>
   <div class="header-section">
      <div class="button">
        <a href="/2023/dashboard/country_premium"><i class="fa fa-arrow-left" aria-hidden="true"></i></a>
    </div>
    <center><h1 class="title-header">Number of Clients in country per premium 2023</h1></center>
      </div>
  ...
  <script type="text/javascript">
      $(document).ready(function () {
          const table = $('#table').DataTable({
              ...
              "serverSide": true,
              "ajax": {
                  "url": "{{ route('country_premium_index_2023') }}",
                  "data": function(d) {
