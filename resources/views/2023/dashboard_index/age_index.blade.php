...
<html>
<head>
  <title>Number of Clients per Age 2023</title>
  <meta charset="utf-8">
...
<body>
   <div class="header-section">
      <div class="button">
        <a href="/2023/dashboard/age"><i class="fa fa-arrow-left" aria-hidden="true"></i></a>
    </div>
    <center><h1 class="title-header">Number of Clients per Age 2023</h1></center>
      ...
      $(document).ready(function () {
          const table = $('#table').DataTable({
              ...
              "columns": [
                  ...
                  { data: 'age', name: 'age' , className:'include' },
