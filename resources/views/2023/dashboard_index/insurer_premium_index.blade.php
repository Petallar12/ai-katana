...
<html>
<head>
  <title>Clients per Insurer and their Premium 2023</title>
  <meta charset="utf-8">
...
<body>
   <div class="header-section">
      <div class="button">
        <a href="/2023/dashboard/insurer_premium"><i class="fa fa-arrow-left" aria-hidden="true"></i></a>
    </div>
    <center><h1 class="title-header">Clients per Insurer and their Premium 2023</h1></center>
      </div>
  ...
  <script type="text/javascript">
      $(document).ready(function () {
          const table = $('#table').DataTable({
              ...
              "serverSide": true,
              "ajax": {
                  "url": "{{ route('insurer_premium_index_2023') }}",
                  "data": function(d) {
              ...
              "columns": [
                  ...
                  { data: 'commission_2023', name: 'commission_2023' , className:'include'},
