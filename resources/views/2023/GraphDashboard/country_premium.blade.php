        ...
        Highcharts.chart('container', {
            ...
            xAxis: {
                ...
                labels: {
                    ...
                    formatter: function() {
                        return '<a href="/2023/dashboard_index/country_premium_index?country_residence=' + encodeURIComponent(this.value) + '">' + this.value + '</a>';
                    },
                    style: {
                        textAlign: 'center',
                        whiteSpace: 'nowrap'
            ...
            plotOptions: {
                ...
                series: {
                    ...
                    point: {
                        events: {
                            click: function () {
                                var url = '/2023/dashboard_index/country_premium_index?country_residence=' + encodeURIComponent(this.category);
