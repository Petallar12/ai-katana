...
<body>
    ...
    <div class="card">
        <div class="card-header">EMA Calculator<h4>(Values are updated online)</h4></div>
				...
				<form action="{{ route('currency') }}"  method="get"  id="quiz-form">
                    ...
                    <input class="lblDisplay" type="text" name="convert_USD" value="{{$converted}}" readonly>
                    <br><br>
...
<div class="card">
	<div class="card-header">EMA Calculator</div>
		<form action="/calculator/ema" method="post" id="quiz-form">
		@csrf

			<form action="/calculator/ema" method="POST">
