...
<body>
    ...
    <div class="card">
        <div class="card-header">Aetna Calculator<h4>(Values are updated online)</h4></div>
...
{{-- <div class="card">
	<div class="card-header">Aetna Calculator</div>
		<form action="/calculator/aetna" method="post" id="quiz-form">
		@csrf

			<form action="/calculator/aetna" method="POST">
